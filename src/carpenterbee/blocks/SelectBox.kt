...
public open class SelectBox<TParent : Block, TDefaultRoute : Block>(
    ...
    public override fun iterator(): Iterator<BoxOption<TParent, TDefaultRoute>> =
        getElements<BoxOption<TParent, TDefaultRoute>, SelectBox<TParent, TDefaultRoute>, TDefaultRoute>(
            ::Option, this, by.tag("option"), { route(it.parent) }).iterator()
}